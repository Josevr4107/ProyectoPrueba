      ...
      <tr>
        ...
        <td>
          <div class="btn-group" role="group">
            <button id="btn_show" type="button" data-toggle="modal" data-target="#CotizacionShow{{ $cotizacion->id }}"
              class="btn btn-sm btn-secondary"><i class="fas fa-eye"></i></button>

            <button id="btn_edit" type="button" data-toggle="modal" data-target="#CotizacionEdit{{ $cotizacion->id }}"
              class="btn btn-sm btn-secondary"><i class="fas fa-edit"></i></button>

            <button id="btn_estado" type="button" data-toggle="modal"
              data-target="#CotizacionEstado{{ $cotizacion->id }}" class="btn btn-sm btn-secondary"><i
                class="fas fa-adjust"></i></button>

            <button id="btn_estado" type="button" data-toggle="modal"
              data-target="#CotizacionDestroy{{ $cotizacion->id }}" class="btn btn-danger" {{ $cotizacion->estado ?
