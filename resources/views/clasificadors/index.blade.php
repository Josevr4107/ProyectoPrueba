        ...
        <td>
          <div class="btn-group" role="group">
            <button id="btn_show" type="button" data-toggle="modal"
              data-target="#ClasificadorShow{{ $clasificador->id }}" class="btn btn-sm btn-info"><i
                class="fas fa-eye"></i></button>

            <button id="btn_edit" type="button" data-toggle="modal"
              data-target="#ClasificadorEdit{{ $clasificador->id }}" class="btn btn-sm btn-primary"><i
                class="fas fa-edit"></i></button>

            <button id="btn_estado" type="button" data-toggle="modal"
              data-target="#ClasificadorEstado{{ $clasificador->id }}" class="btn btn-sm btn-secondary"><i
                class="fas fa-adjust"></i></button>

            <button id="btn_estado" type="button" data-toggle="modal"
              data-target="#ClasificadorDestroy{{ $clasificador->id }}" class="btn btn-danger" {{ $clasificador->estado
