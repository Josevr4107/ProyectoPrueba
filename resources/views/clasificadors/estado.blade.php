<div class="modal fade" id="ClasificadorEstado{{$clasificador->id}}" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content bg-dark-x text-light">
      ...
      <form action="{{ route('clasificadors.actualizar_estado',$clasificador) }}" method="post">
        @csrf
