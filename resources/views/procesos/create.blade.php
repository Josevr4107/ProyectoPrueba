        ...
        <div class="modal-body">
          <div class="row">
            {{-- <div class="col-md-2 col-xs-12">
              ...
              <input type="number" min="1" pattern="^[0-9]+" required name="nro"
                class="form-control mb-2 @error('nro') is-invalid @enderror" id="nro" placeholder="Orden"
                value="{{ old('nro') }}">
            ...
            <div class="col-md-12 col-xs-12">
              ...
              <input type="text" required name="descripcion"
                ...
                placeholder="Nombre o Descripción del Proceso" value="{{ old('descripcion') }}">
          ...
          <div class="row">
            ...
            <div class="col-md-10 col-12">
              ...
              <div class="wrapeo">
                <select name="tipotrabajo_id" class="form-control selectpicker" onfocus='this.size=5;'
