            ...
            <form method="post" action="{{ route('clientes.store') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-7 col-xs-12">
                            ...
                            <input type="text" required name="nombre"
                                class="form-control mb-2 @error('nombre') is-invalid @enderror" id="nombre"
                                placeholder="Nombre o Razón Social" value="{{ old('nombre') }}">
                        ...
                        <div class="col-md-5 col-xs-12">
                            ...
                            <input type="number" min="1" pattern="^[0-9]+" required name="cinit"
                                class="form-control mb-2 @error('cinit') is-invalid @enderror" id="cinit"
                                placeholder="CI / NIT" value="{{ old('cinit') }}">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6">
                            ...
                            <input type="text" name="direccion"
                                class="form-control mb-2 @error('direccion') is-invalid @enderror" id="direccion"
                                placeholder="Dirección del Cliente" value="{{ old('direccion') }}">
                        ...
                        <div class="col-xs-12 col-md-3">
                            ...
                            <input type="number" min="1" pattern="^[0-9]+"
                                class="form-control mb-2 @error('cel1') is-invalid @enderror" required name="cel1"
                                id="cel" placeholder="Nro. Celular 1" value="{{ old('cel1') }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label>Correo:</label>
                            <input type="email" class="form-control mb-2 @error('correo') is-invalid @enderror"
                                name="correo" id="correo" placeholder="nombre@correo.com"
                                value="{{ old('correo') }}">
