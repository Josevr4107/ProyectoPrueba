<div class="modal fade" id="ClienteEstado{{$cliente->id}}" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal-content bg-dark-x text-light">
        ...
        <form action="{{ route('clientes.actualizar_estado',$cliente) }}" method="post">
        @csrf
