        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-7 col-xs-12">
              <label>Nombre:</label>
              <input type="text" name="nombre" class="form-control mb-2" required value="{{ $cliente->nombre }}">
            </div>

            <div class="col-md-5 col-xs-12">
              <label>CI/NIT:</label>
              <input type="number" min="1" pattern="^[0-9]+" name="cinit" class="form-control mb-2" required
                value="{{ $cliente->cinit }}">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-md-3">
              ...
              <input type="number" min="1" pattern="^[0-9]+" class="form-control mb-2" name="cel1" required
                value="{{ $cliente->cel1 }}">
            </div>
          ...
          <div class="row">
            <div class="col-12">
              <label>Correo:</label>
              <input type="email" class="form-control mb-2" name="correo" value="{{ $cliente->correo }}">
            </div>
          </div>
