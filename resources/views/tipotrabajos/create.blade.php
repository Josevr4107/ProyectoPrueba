      ...
      <form method="post" action="{{ route('tipotrabajos.store') }}">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <textarea name="descripcion" class="form-control mb-2 @error('descripcion') is-invalid @enderror"
                id="descripcion" rows="3" placeholder="Descripción del Tipo de Trabajo"
          ...
          <div class="row">
            <div class="col-12">
              <label>Tipo:</label>
              <input type="text" name="codigo" class="form-control mb-2 @error('codigo') is-invalid @enderror" required
                id="codigo" placeholder="Tipo de Trabajo al que pertenece" value="{{ old('codigo') }}">
