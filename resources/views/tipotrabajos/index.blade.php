  ...
  <form action="{{ route('buscar_tipotrabajo') }}" method="post">
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-2 col-xs-12  mb-3">
        <button id="btn_nuevo" type="button" data-toggle="modal" data-target="#TipotrabajoCreate"
        ...
        <td>
          <div class="btn-group" role="group">
            ...
            <button id="btn_estado" type="button" data-toggle="modal"
              data-target="#TipotrabajoEstado{{$tipotrabajo->id}}" class="btn btn-sm btn-secondary"><i
                class="fas fa-adjust"></i></button>

            <button id="btn_estado" type="button" data-toggle="modal"
              data-target="#TipotrabajoDestroy{{$tipotrabajo->id}}" class="btn btn-danger" {{ $tipotrabajo->estado ?
