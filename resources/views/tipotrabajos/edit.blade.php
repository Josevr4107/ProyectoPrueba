      ...
      <form method="post" action="{{ route('tipotrabajos.update', $tipotrabajo) }}">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-12">
              <label>Nombre:</label>
              <input type="text" name="nombre" class="form-control mb-2" required value="{{ $tipotrabajo->nombre }}">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12">
              <label>Tipo:</label>
              <input type="text" name="codigo" class="form-control mb-2" required value="{{ $tipotrabajo->codigo }}">
            </div>
          </div>
